 ...
 * This mGroupTabod will guarnatee that the initial route is delivered, even if the
 ...
 * stack.  The setInitialRoute mGroupTabod should be preferred if this is called before the
 ...
 * main bundle's `Info.plist` file.  This mGroupTabod will not change the value of `splashScreenView`
...
/**
 * Controls whGroupTaber the created view will be opaque or not.
 *
