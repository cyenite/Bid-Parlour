...
import '../../component/loserModel.dart';

class PastBid extends StatefulWidget {
  final Widget child;

  PastBid({Key key, this.child}) : super(key: key);

  _PastBidState createState() => _PastBidState();
}

class _PastBidState extends State<PastBid> {
  ///
...
Widget listPricePastBid(PastBids item, BuildContext ctx) {
  return Padding(
...
Widget loadingListPricePastBid(PastBids item, BuildContext ctx) {
  return Padding(
...
Widget _loadingImageAnimation(BuildContext context) {
  return Container(
    child: ListView.builder(
      shrinkWrap: true,
      primary: false,
      itemCount: PastBidsList.length,
      itemBuilder: (ctx, i) {
        return loadingListPricePastBid(PastBidsList[i], ctx);
      },
    ),
  );
}
...
Widget _imageLoaded(BuildContext context) {
  return Container(
    child: ListView.builder(
      ...
      itemCount: PastBidsList.length,
      itemBuilder: (ctx, i) {
        return listPricePastBid(PastBidsList[i], ctx);
      },
    ),
  );
}
