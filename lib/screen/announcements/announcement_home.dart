...
import '../../component/News/newsHeaderModel.dart';
import '../../component/News/newsListBottom.dart';
import 'news_header_slider/intro_page_item.dart';
import 'news_header_slider/page_transformer.dart';
import 'news_list_detail/news_list_detail.dart';

class Announcements extends StatefulWidget {
  final Widget child;

  Announcements({Key key, this.child}) : super(key: key);
            ...
            Column(
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: _loadingDataHeader(context),
                ),
                Padding(
                  padding: const EdgeInsets.only(top: 40.0, left: 30.0),
                  child: Text("Bid Parlour Announcements",
                      style: TextStyle(
                          fontFamily: "Popins",
                          fontSize: 16.0,
                ...
                Padding(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                        fontFamily: "Gotik",
                        fontWeight: FontWeight.w700,
                        color: colorStyle.fontColorDark.withOpacity(0.3)),
                  ),
                ),
                Padding(
                  padding: const EdgeInsets.only(top: 7.0),
